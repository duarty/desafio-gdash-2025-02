...
import { WeatherLog, WeatherLogSchema } from './infrastructure/persistence/mongoose/schemas/weather-log.schema';
...
@Module({
    ...
    providers: [
        MongooseWeatherRepository,
        {
            ...
            useFactory: (repo: MongooseWeatherRepository) => new CreateWeatherLogUseCase(repo),
            inject: [MongooseWeatherRepository],
        },
        {
            provide: GetWeatherLogsUseCase,
            useFactory: (repo: MongooseWeatherRepository) => new GetWeatherLogsUseCase(repo),
            inject: [MongooseWeatherRepository],
        },
        {
            provide: GenerateInsightsUseCase,
            useFactory: (repo: MongooseWeatherRepository) => new GenerateInsightsUseCase(repo),
            inject: [MongooseWeatherRepository],
        },
    ],
})
