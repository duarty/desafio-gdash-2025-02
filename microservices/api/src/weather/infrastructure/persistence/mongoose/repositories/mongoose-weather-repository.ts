...
import { WeatherLogDocument, WeatherLog as WeatherLogSchema } from '../schemas/weather-log.schema';
...
export class MongooseWeatherRepository implements WeatherRepository {
    ...
    async create(data: Omit<WeatherLog, 'id' | 'createdAt' | 'updatedAt'>): Promise<WeatherLog> {
